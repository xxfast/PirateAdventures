...
fun MainUIViewController(rootComponentContext: DefaultComponentContext): UIViewController {
  val mainComponent = MainComponent(rootComponentContext)
  return ComposeUIViewController {
    MaterialTheme {
      PredictiveBackGestureOverlay(
        backDispatcher = rootComponentContext.backHandler as BackDispatcher,
        backIcon = { progress, _ ->
